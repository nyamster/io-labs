 ...
 * +-----------------------+-----------------------+---------+--------+
 * | Privary volume 25 MiB | Privary volume 25 MiB | 0x5800  | 0xC800 |
 * +-----------------------+-----------------------+---------+--------+
 * | Privary volume 15 MiB | Privary volume 15 MiB | 0x12000 | 0x7800 |
 * +-----------------------+-----------------------+---------+--------+
 */
...
static part_table def_part_table = {
    ...
    },
    {
        ...
        .part_type = 0x83,
        /* coords */
        PART_ENTRY_COORDS_BY_LBA(0x5800, 0xC800)
    },
{
        /* not primary */
        .boot_type = 0,
        ...
        .part_type = 0x83,
        /* coords */
        PART_ENTRY_COORDS_BY_LBA(0x11200, 0x7800)
    },
};
